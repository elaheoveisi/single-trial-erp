...
#Show bad channels (channels with excessive noise or artifacts)
print(raw.info["bads"])  # Print list of bad channels (if any)  
raw = mne.io.read_raw_bdf(sample_data_raw_file, preload=True, verbose=False)
